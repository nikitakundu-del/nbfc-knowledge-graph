...
| [[Dashboard - DIY BOF]] | Power BI | Trusted for documented semantic metrics | XMLA semantic-model read exposed BOF journey, friction, and application measure logic. |
